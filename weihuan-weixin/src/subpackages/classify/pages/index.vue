...
import Search from '@/pages/component/search.vue';
import MenuChild from '@/subpackages/classify/components/menu.vue';
import Item from '@/subpackages/classify/components/item.vue';
